...
## Corpus Check
- 137 files · ~71,752 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1840 nodes · 4694 edges · 100 communities (95 shown, 5 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 557 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c96c882`
...
Cohesion: 0.09
Nodes (61): get_settings(), TestClient, _enable_litellm_engine(), Point settings at a local single-model catalog with litellm selected.     conft, _sse_payloads(), test_brief_mode_sends_rubric_text_and_keeps_default_criteria(), test_classroom_links_endpoint_backfills_links_and_posted_state(), test_create_job_exposes_visual_submission_consent() (+53 more)

### Community 3 - "Grading Router & Job Snapshots"
Cohesion: 0.07
Nodes (69): Build the grading engine, translating config failures (missing key /     disabl, resolve_grading_engine(), GradingEngine, GradingJob, Session, GradingJob, Session, GradingJob (+61 more)
...
Cohesion: 0.12
Nodes (34): Activity, AuthFailure, _contains_invalid_grant(), google_auth_http_exception(), _http_403_is_hard_auth_failure(), _http_error_content(), Google auth-error → HTTP translation.  Pure, no side effects., purge_cached_classroom_state_for_user() (+26 more)
...
Cohesion: 0.23
Nodes (3): ClassroomCourse, MockGoogleProvider, safe_fields()
...
Cohesion: 0.23
Nodes (14): GradingEngine, Session, UserSession, estimate_cost_cents(), AppEvent, GradingAiAttemptPayload, configure_logging(), DbEventHandler (+6 more)

### Community 22 - "Observability & Logging"
Cohesion: 0.27
Nodes (25): BaseModel, ExportStatus, GradingStatus, ActivityRead, AdminStats, AiAttemptAdminRead, AiAttemptPayloadRead, AppEventRead (+17 more)
...
Cohesion: 0.12
Nodes (30): _as_utc(), _cache_headers(), _conditional_response(), _etag(), _if_none_match(), _is_fresh(), _is_future(), SSE + generic HTTP-cache primitives.  No domain dependencies. (+22 more)

### Community 35 - "Community 35"
Cohesion: 0.09
Nodes (21): init_db(), test_auth_me_profile_failure_keeps_loadable_google_token_signed_in(), test_course_cache_logs_standard_hit_miss_pair(), test_courses_exclude_archived(), test_courses_reports_expired_google_session_as_unauthorized(), test_export_creates_email_first_manifest_paths(), test_file_content_stream_uses_private_etag_cache(), test_file_content_streams() (+13 more)

### Community 36 - "Community 36"
Cohesion: 0.17
Nodes (28): Session + provider + filesystem cache purge (side-effectful)., GradingAiAttempt, GradingSubmission, GradingSubmissionFile, Path, GradingJob, Session, Activity (+20 more)

### Community 37 - "Community 37"
Cohesion: 0.56
Nodes (8): GradingFileCache, Path, _decode_text(), extract_submission_content(), _extract_zip_content(), _is_zip_submission(), _safe_source_label(), text_preview()

### Community 38 - "Community 38"
Cohesion: 0.29
Nodes (13): GradingCriterion, Session, GradingEngine, GradingCriterionInput, _apply_criterion_notes(), _criteria_match_defaults(), ensure_default_criteria(), _is_substantial_description() (+5 more)
...
Cohesion: 0.13
Nodes (17): AdminStats, AiAttemptAdminRead, AiAttemptPayloadRead, Session, AppEvent, datetime, Session, get_session() (+9 more)
...
Cohesion: 0.10
Nodes (19): required, title, type, required, title, type, components, schemas (+11 more)
...
Cohesion: 0.30
Nodes (20): ExtractedSubmissionContent, GradingJob, GradingSubmission, Session, GradingJob, GradingSubmission, ExtractedSubmissionContent, GradingJob (+12 more)

### Community 66 - "Community 66"
Cohesion: 0.22
Nodes (20): AppEvent, _ensure_activity_columns(), _ensure_cache_columns(), _ensure_columns(), _ensure_grading_ai_attempt_columns(), _ensure_grading_criterion_columns(), _ensure_grading_job_columns(), _ensure_grading_submission_columns() (+12 more)

### Community 67 - "Community 67"
Cohesion: 0.32
Nodes (5): DbTokenStore, get_google_provider(), make_google_provider(), Legacy single-user helper. Use make_google_provider() for multi-user flows., Loads and refreshes Google credentials stored in the UserSession DB row.
...
Cohesion: 0.35
Nodes (11): Any, _bounded_repr(), _bounded_text(), _format_event(), _format_value(), log_debug(), log_error(), _safe_payload() (+3 more)
...
Cohesion: 0.33
Nodes (3): GoogleApiProvider, submission_links_from_submission(), SubmissionLink
...
Cohesion: 0.21
Nodes (12): datetime, AccountProfile, _cache_hit(), _ttl(), _TtlCacheEntry, byte_preview(), log_cache_hit(), log_cache_miss() (+4 more)
...
Cohesion: 0.08
Nodes (31): admin_email_set(), _as_utc(), get_current_session(), get_current_user_email(), is_admin_email(), provider_dependency(), FastAPI dependencies: session, user, provider, grading engine., require_admin() (+23 more)
...
- **Why does `log_event()` connect `Grading Router & Job Snapshots` to `Persistence & API Dependencies`, `LiteLLM Grading Engine`, `LLM Catalog & Settings`, `Google Classroom Provider`, `Schemas & Privacy Audit`, `Auth Flow & Token Store`, `Exports Router & File Naming`, `Provider Sessions & Cache Logging`, `Navigation Rail & Theme`, `Community 34`, `Community 37`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 58`, `Community 65`, `Community 66`, `Community 67`, `Community 69`, `Community 76`, `Community 78`, `Community 87`, `Community 109`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `get_settings()` connect `Grading Tests & Settings` to `Persistence & API Dependencies`, `Grading Router & Job Snapshots`, `LiteLLM Grading Engine`, `LLM Catalog & Settings`, `Google Classroom Provider`, `Provider Sessions & Cache Logging`, `Navigation Rail & Theme`, `Community 34`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 42`, `Community 58`, `Community 66`, `Community 67`, `Community 69`, `Community 84`, `Community 87`, `Community 109`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `schemas` connect `Community 45` to `Community 70`, `Community 40`, `Community 73`, `Community 43`, `Community 47`, `Community 80`, `Community 49`, `Community 83`, `Community 54`, `Community 55`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 63`?**
